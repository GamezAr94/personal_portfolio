// Portfolio
import portfolio_1 from "@/public/img/personalPortfolio/portfolio_1.png";
import portfolio_2 from "@/public/img/personalPortfolio/portfolio_2.png";
import portfolio_3 from "@/public/img/personalPortfolio/portfolio_3.png";
import portfolio_4 from "@/public/img/personalPortfolio/portfolio_4.png";
import portfolio_5 from "@/public/img/personalPortfolio/portfolio_5.png";
import portfolio_6 from "@/public/img/personalPortfolio/portfolio_6.png";
import portfolio_7 from "@/public/img/personalPortfolio/portfolio_7.png";
...
const Portfolio = {
    ...
    gallery: [
        {
            img: portfolio_1,
            alt: "Screen shot of the banner of my portfolio",
        },
        {
            img: portfolio_2,
            alt: "Screen shot of the banner of my portfolio",
        ...
        {
            img: portfolio_6,
            alt: "screen shot of the figma design early stage of my personal portfolio website",
        },
        {
            img: portfolio_7,
            alt: "screen shot of the figma design early stage of my personal portfolio website",
    ...
    // TODO Implement this
    links: ["https://github.com/GamezAr94/personal_portfolio"],
    tech_stack: [
        "Next.js",
        "Figma",
        "CSS",
    ...
    project_desc: [
        "Developed a dynamic and visually engaging personal portfolio website using Next.js to showcase my projects and skills. This project emphasizes modern design principles, interactive elements, and seamless user experience.",
        "***Key Features:***",
        "Implemented modern layouts, including the Bento Box style, and integrated interactive 3D models that respond to mouse movements, showcasing design creativity and technical skills.",
        "Provided three distinct themes, allowing users to personalize their viewing experience and demonstrating attention to user preferences.",
        "Incorporated Matter.js to create an interactive section where users can manipulate and interact with 3D 'technology bricks,' adding a playful and engaging element.",
        "Utilized GSAP for smooth and captivating animations, contributing to a modern and polished aesthetic.",
        "Implemented a contact form with Google reCAPTCHA to prevent spam and ensure genuine inquiries.",
        "Integrated Google Analytics to track website traffic and user behavior, enabling data-driven insights for continuous improvement.",
        "Animated 3D models using Spline, showcasing some experience in 3D design and animation tools.",
        "Utilized Figma for prototyping and refining the website's design before implementation.",
        "***Learning Outcomes:***",
        "Gained expertise in Next.js for building performant and SEO-friendly React applications.",
        "Mastered the implementation of modern layouts, including the Bento Box style.",
        "Learned to seamlessly integrate and animate 3D models, enhancing user engagement.",
        "Acquired skills in using Matter.js to create interactive physics simulations within the website.",
        "Developed proficiency in creating smooth and eye-catching animations using GSAP.",
        "Focused on crafting a user-friendly and accessible experience across different devices and themes.",
        "***Project Status & Future Plans:***",
        "The portfolio is continuously evolving as new projects and skills are added.",
        "The primary goal is to effectively present my skills and projects to potential employers and collaborators.",
    ],
};
const CafeLokal = {
    title: "Cafe Lokal",
    ...
    alt_main_img:
        "image of the banner of the main page of the cafe lokal website",
    gallery: [
        {
            img: cafelokal_sm,
...
const FrogGame = {
    ...
    alt_main_img: "screenshot of a unity 2d game of a frog collecting flies",
    gallery: [
        {
            img: froggame_sm,
...
// This is a template to add new projects
/*
const Template = {
    ...
    // main img gif and fallback option for mobile
    main_image: ["img/frogGame/frog_game_gameplay_gif.gif", froggame_sm],
    alt_main_img: "Screenshot desc for the main img",
    gallery: [
        {
            img: screenshot_1,
            alt: "Screenshot desc",
...
// To display the projects create the const above and then add it here
const project_list = [
    Portfolio,
    OnlineIDE,
    APathFinding,
