...
const jobData = [
    {
        ...
        dates: '2021 - Present',
        description:
            'Responsible for developing and aintaining web applications using React, Next.js, and Node.js. Collaborated with a team of 5 to build a new customer-facing dashboard, reducing support tickets by 30%.',
        tags: ['Next.js', 'React', 'TypeScript', 'Node.js', 'PostgreSQL'],
        aiQuery: 'Tell me about the Full-Stack Developer role at [Company]',
    },
    {
        ...
        dates: '2019 - 2021',
        description:
            'Worked directly with small businesses to build and design responsive websites. Handled everything from initial concept and UI/UX design to final deployment and maintenance.',
        tags: ['JavaScript', 'PHP', 'WordPress', 'SCSS', 'MySQL'],
